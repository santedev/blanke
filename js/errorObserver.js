...
let observerErrCheckout = new MutationObserver((mutations) => {
    mutations.forEach((mutation) => {
        if (mutation.type === "childList") {
            let errorPopUp = document.querySelector(".wc-block-components-checkout-step__container .wc-block-components-checkout-step__content .wc-block-components-notices div .wc-block-components-notice-banner__content div");
            if (errorPopUp) {
                if (errorPopUp.textContent ==
...
//# sourceMappingURL=errorObserver.js.map